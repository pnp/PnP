...
namespace OfficeDevPnP.Core {
    ...
    internal class CoreResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to ObjectLookupFields failed to update field with ID &apos;{0}&apos; StaticName &apos;{1}&apos; on url &apos;{2}&apos;, because not exist..
        /// </summary>
        internal static string ObjectLookupFields_FieldNotExist {
            get {
                return ResourceManager.GetString("ObjectLookupFields_FieldNotExist", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to ObjectLookupFields failed to update field with ID &apos;{0}&apos; StaticName &apos;{1}&apos;, bacause list on url &apos;{2}&apos; not exist..
        /// </summary>
        internal static string ObjectLookupFields_ListNotExist {
            get {
                return ResourceManager.GetString("ObjectLookupFields_ListNotExist", resourceCulture);
            }
        }
