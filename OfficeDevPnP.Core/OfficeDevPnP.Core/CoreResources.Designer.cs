...
namespace OfficeDevPnP.Core {
    ...
    internal class CoreResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Adding web part &apos;{0}&apos; in zone &apos;{1}&apos; at index &apos;{2}&apos; to page layout &apos;{3}&apos;.
        /// </summary>
        internal static string BrandingExtensions_AddWebPartToPageLayout {
            get {
                return ResourceManager.GetString("BrandingExtensions_AddWebPartToPageLayout", resourceCulture);
            }
        }
