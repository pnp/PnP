...
namespace OfficeDevPnP.Core {
    ...
    internal class CoreResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Feature provisioning error {0}.
        /// </summary>
        internal static string Provisioning_ObjectHandlers_Features_Exception {
            get {
                return ResourceManager.GetString("Provisioning_ObjectHandlers_Features_Exception", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Site security error {0}.
        /// </summary>
        internal static string Provisioning_ObjectHandlers_SiteSecurity_Exception {
            get {
                return ResourceManager.GetString("Provisioning_ObjectHandlers_SiteSecurity_Exception", resourceCulture);
            }
        }
