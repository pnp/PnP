...
namespace OfficeDevPnP.Core {
    ...
    internal class CoreResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Maximum retry attempts {0} exceeded..
        /// </summary>
        internal static string ClientContext_MaxRetryAttemptsExceeded {
            get {
                return ResourceManager.GetString("ClientContext_MaxRetryAttemptsExceeded", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string ClientContext_RequestFrequencyExceed {
            get {
                return ResourceManager.GetString("ClientContext_RequestFrequencyExceed", resourceCulture);
            }
        }
