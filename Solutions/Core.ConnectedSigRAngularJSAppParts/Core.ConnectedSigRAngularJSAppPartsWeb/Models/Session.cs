...
namespace Core.ConnSigRAngJSApps.Models
{
    public class Session : BaseListItem {
        ...
        public string ShortDescription { get { return SessionDescription.Truncate(100, "..."); } }
        ...
        protected override void SetProperties(ListItem item)
        {
            ...
            BaseSet(item, FIELD_SESSIONSTATUS, Status.ToEnumDescription());
        ...
        protected override void ReadProperties(ListItem item)
        {
            ...
            Status = BaseGetEnum<SessionStatus>(item, FIELD_SESSIONSTATUS);
