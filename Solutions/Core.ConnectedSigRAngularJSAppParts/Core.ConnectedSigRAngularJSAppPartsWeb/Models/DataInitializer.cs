...
namespace Core.ConnSigRAngJSApps.Models
{
    class DataInitializer {
        ...
        private static void CreateSampleData(Web web) {
            ...
            {
                Title = "Sample Session #1 - Event 001",
                SessionDescription = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras sit amet augue in dolor dapibus feugiat in eu odio.",
            ...
            {
                Title = "Sample Session #2 - Event 001",
                SessionDescription = "Nullam sed quam felis. Praesent sit amet egestas nunc, nec aliquam eros.",
                SessionImageUrl = host + "/Images/company-events1.jpg",
                Status = SessionStatus.Active,
            ...
            {
                Title = "Sample Session #1 - Event 002",
                SessionDescription = "Nullam sed quam felis. Praesent sit amet egestas nunc, nec aliquam eros.",
                SessionImageUrl = host + "/Images/company-events1.jpg",
                Status = SessionStatus.Active,
            ...
            {
                Title = "Sample Session #2 - Event 002",
                SessionDescription = "Nullam sed quam felis. Praesent sit amet egestas nunc, nec aliquam eros.",
                SessionImageUrl = host + "/Images/company-events1.jpg",
                Status = SessionStatus.Active,
            ...
            {
                Title = "Sample Session #1 - Event 003",
                SessionDescription = "Vestibulum ex mauris, feugiat in vehicula id, congue eleifend elit.",
                SessionImageUrl = host + "/Images/company-events1.jpg",
                Status = SessionStatus.Active,
            ...
            {
                Title = "Sample Session #2 - Event 003",
                SessionDescription = "Proin vel egestas purus. Curabitur accumsan tincidunt lectus et tincidunt.",
                SessionImageUrl = host + "/Images/company-events1.jpg",
                Status = SessionStatus.Active,
            ...
            {
                Title = "Sample Session #3 - Event 003",
                SessionDescription = "Vivamus scelerisque lectus et sapien mollis, ut vestibulum nunc vulputate. Nullam sed quam felis.",
                SessionImageUrl = host + "/Images/company-events1.jpg",
                Status = SessionStatus.Active,
