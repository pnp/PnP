<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Speakers.aspx.cs" Inherits="Core.ConnSigRAngJSApps.Pages.Speakers" %>
...
<body ng-controller="speakersController as vm">

     <div ng-repeat="e in vm.speakers">                            
            <dl>
                <dt class="dl-horizontal">                                                               
                    {{e.speakerfirstname}} {{e.speakerlastname}} 
                </dt>
            </dl>                    
    ...
    <div class="container" style="width:100%">
        <dl class="dl-horizontal" id="speakermessages">
