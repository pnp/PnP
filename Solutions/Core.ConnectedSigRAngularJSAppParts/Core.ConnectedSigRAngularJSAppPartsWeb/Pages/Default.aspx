<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Core.ConnSigRAngJSApps.Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Connected Master/Detail App Parts with SignalR and AngularJS</title>
...
<body style="display: none; overflow: auto;">
    <form id="form1" runat="server">
        ...
        <div style="left: 40px; position: absolute;">
            ...
            This is pretty easy implementation pattern for app parts to communicate between each other. This sample shows a migration dashboard (Master data) with site migration details (detail data)
