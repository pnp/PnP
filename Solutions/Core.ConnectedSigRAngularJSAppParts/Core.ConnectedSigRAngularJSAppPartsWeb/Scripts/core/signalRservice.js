    ...
    angular
        ...
        .factory('signalRservice', function () {
            function signalRops() {
                ...
                var sessionChange = function (data) {
                    corporateEventsHubProxy.invoke('selectedSessionChanged', data);
                };
                var eventChange = function (data) {
                    corporateEventsHubProxy.invoke('selectedEventChanged', data);
                };
                var speakerUpdate = function (data) {
                    corporateEventsHubProxy.invoke('updateSpeakers', data);
                };
                var eventAdd = function (data) {
                    corporateEventsHubProxy.invoke('eventAddition', data);
                };
                var eventCancel = function (data) {
                    corporateEventsHubProxy.invoke('eventCancellation', data);
                };
