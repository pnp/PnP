...
(function ($, window, undefined) {
    ...
    $.hubConnection.prototype.createHubProxies = function () {
        ...
        proxies['corporateEventsHub'].server = {
            eventAddition: function (eventId) {
            ...
            eventCancellation: function (data) {
            ...
            selectedEventChanged: function (data) {
            ...
            selectedSessionChanged: function (data) {
            ...
            sessionCancellation: function (data) {
