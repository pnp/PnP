...
namespace AspNet5.Mvc6.StarterWeb.Ignored
{
    /// <summary>
    ...
    public abstract class SharePointContext
    {
        ...
        protected static readonly TimeSpan AccessTokenLifetimeTolerance =
        ...
        public static Uri GetSPHostUrl(HttpRequest httpRequest)
        {
            ...
            //BUG: potential issue with more than 1
            string spHostUrlString = TokenHelper.EnsureTrailingSlash
                (httpRequest.Query[SPHostUrlKey]);
            Uri spHostUrl;
    ...
    public abstract class SharePointContextProvider
    {
        ...
        public static RedirectionStatus CheckRedirectionStatus
            (HttpContext httpContext, out Uri redirectUrl)
        {
            if (httpContext == null)
            {
            ...
            PathString requestUrl = httpContext.Request.Path;

            var queryNameValueCollection = httpContext.Request.Query; //.ParseQueryString(requestUrl.Query);
    ...
    {
        private readonly IPrincipal logonUserIdentity;

        /// <summary>
        /// The Windows identity for the current user.
        /// </summary>
        public IPrincipal LogonUserIdentity
        {
        ...
        public SharePointHighTrustContext(Uri spHostUrl, Uri spAppWebUrl, string spLanguage, string spClientTag, string spProductNumber, IPrincipal logonUserIdentity)
            : base(spHostUrl, spAppWebUrl, spLanguage, spClientTag, spProductNumber)
        {
    ...
    public class SharePointHighTrustContextProvider : SharePointContextProvider
    {
        ...
        protected override SharePointContext CreateSharePointContext(Uri spHostUrl, Uri spAppWebUrl, string spLanguage, string spClientTag,
            string spProductNumber, HttpRequest httpRequest)
        {
            IPrincipal logonUserIdentity = httpRequest.HttpContext.User;
            if (logonUserIdentity == null || !logonUserIdentity.Identity.IsAuthenticated 
            ...
            return new SharePointHighTrustContext(spHostUrl, spAppWebUrl, spLanguage,
                spClientTag, spProductNumber, logonUserIdentity);
        }
        ...
        protected override SharePointContext LoadSharePointContext(HttpContext httpContext)
        {
            ...
            var storedContext = JsonConvert.DeserializeObject(httpContext.Session.GetString(SPContextKey));
            return storedContext as SharePointHighTrustContext;
        }
