...
2.2 | March 11th 2018 | <ul style="list-style: none"><li>Bug fixes (Fixed news tile display template)</li><li>Added a "comments" component for pages based on the OOTB SharePoint discussion board</li></ul>
