...
namespace Framework.Provisioning.Core.Mail
{
    public class EmailHelper
    {
        ...
        public static void SendNewSiteSuccessEmail(SuccessEmailMessage message)
        {
            ...
            {
                Log.Fatal("Framework.Provisioning.Core.Mail.EmailHelper.SendNewSiteSuccessEmail", "There was an error sending email. The exception is {0}", ex);
            }
        }
        ...
        public static void SendFailEmail(FailureEmailMessage message)
        {
            ...
            {
                Log.Fatal("Framework.Provisioning.Core.Mail.EmailHelper.SendFailEmail", "There was an error sending email. The exception is {0}", ex);
            }
        }
        #endregion
    }
