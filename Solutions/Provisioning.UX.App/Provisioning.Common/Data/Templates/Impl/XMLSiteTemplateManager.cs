    ...
    internal class XMLSiteTemplateManager : AbstractModule, ISiteTemplateManager
    {
        ...
        public ProvisioningTemplate GetProvisioningTemplate(string name)
        {
            ...
            catch(Exception _ex)
            {
                ...
                this._logger.Error("Provisioning.Common.Data.Templates.Impl.XMLSiteTemplateManager", PCResources.TemplateProviderBase_Exception_Message, _ex);
        ...
        private void LoadXML()
        {
            try
            {
                ...
                this._logger.Information("Provisioning.Common.Data.Templates.Impl.XMLSiteTemplateManager.LoadXML", PCResources.XMLTemplateManager_TryRead_ConfigFile, _filePath);

                if(_fileExists)
                {
                    XDocument _doc = XDocument.Load(_filePath);
                    this._data = XmlSerializerHelper.Deserialize<XMLSiteTemplateData>(_doc);
                    this._logger.Information("Provisioning.Common.Data.Templates.Impl.XMLSiteTemplateManager.LoadXML", PCResources.XMLTemplateManager_Loaded_ConfigFile, _filePath);
                }
                else
                {
                    ...
                    if (_fileExists)
                    {
                        this._logger.Information("Provisioning.Common.Data.Templates.Impl.XMLSiteTemplateManager.LoadXML", PCResources.XMLTemplateManager_File_Found, _filePath);
                        XDocument _doc = XDocument.Load(_filePath);
                        this._data = XmlSerializerHelper.Deserialize<XMLSiteTemplateData>(_doc);
                        this._logger.Information("Provisioning.Common.Data.Templates.Impl.XMLSiteTemplateManager.LoadXML", PCResources.XMLTemplateManager_Loaded_ConfigFile, _filePath);
                    }
                    else
                    {
                        ...
                        this._logger.Error("Provisioning.Common.Data.Templates.Impl.XMLSiteTemplateManager.LoadXML", _message);
            ...
            {
                this._logger.Error("Provisioning.Common.Data.Templates.Impl.XMLSiteTemplateManager", PCResources.XMLTemplateManager_Error, _ex.Message, _ex.StackTrace);
                throw;
            }
