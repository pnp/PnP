    ...
    public sealed class SiteTemplateFactory : ISiteTemplateFactory
    {
        ...
        public ISiteTemplateManager GetManager()
        {
            ...
            try
            {
                ...
                this._logger.Information("Provisioning.Common.Data.Templates", PCResources.SiteTemplate_Factory_Created_Instance, _managerTypeString);
            ...
            catch (Exception _ex)
            {
                ...
                this._logger.Error("Provisioning.Common.Data.Templates", _message) ;
