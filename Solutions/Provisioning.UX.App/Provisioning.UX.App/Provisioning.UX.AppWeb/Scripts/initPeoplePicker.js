            ...
            $.getScript(layoutsRoot + 'SP.js',
                function () {
                    ...
                    $.getScript(layoutsRoot + 'SP.RequestExecutor.js', function () {
                        ...
                        csomPeoplePicker = new CAMControl.CsomPeoplePicker('Wizard.aspx/GetPeoplePickerData', spHostUrl, $('#spanCsomAdministrators'), $('#inputCsomAdministrators'), $('#divCsomAdministratorsSearch'), $('#hdnCsomAdministrators'));
