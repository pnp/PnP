...
namespace Contoso.Core.JavaScriptCustomization.AppWeb.Pages
{
    public partial class scenario3 : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                cc.Web.AddJsLink(Utilities.Scenario3Key, Utilities.BuildScenarioJavaScriptUrl(Utilities.Scenario3Key, this.Request));
            }
        }
        ...
        protected void btnRemove_Click(object sender, EventArgs e)
        {
            ...
            using (var cc = spContext.CreateUserClientContextForSPHost())
            {
                cc.Web.DeleteJsLink(Utilities.Scenario3Key);
            }
        }
    }
}