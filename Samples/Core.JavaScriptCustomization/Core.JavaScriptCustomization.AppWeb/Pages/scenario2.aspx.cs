...
namespace Contoso.Core.JavaScriptCustomization.AppWeb.Pages
{
    public partial class scenario2 : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                cc.Web.AddJsLink(Utilities.Scenario2Key, Utilities.BuildScenarioJavaScriptUrl(Utilities.Scenario2Key, this.Request));
            }
        }
        ...
        protected void btnRemove_Click(object sender, EventArgs e)
        {
            ...
            using (var cc = spContext.CreateUserClientContextForSPHost())
            {
                cc.Web.DeleteJsLink(Utilities.Scenario2Key);
            }
        }
    }
}