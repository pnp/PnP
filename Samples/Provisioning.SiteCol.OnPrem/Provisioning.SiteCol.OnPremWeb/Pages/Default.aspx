<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Contoso.Provisioning.SiteCol.OnPremWeb.Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Site Collection Creation - On Premises</title>
            ...
            <ContentTemplate>
                <div style="width: 450px; margin-left:50px; ">
                    ...
                    <div id="divFieldDescription">
                        <h3 class="ms-core-form-line">Provide admininistrator account for the site collection</h3>
                        <div class="ms-core-form-line">
                            <asp:TextBox ID="txtAdminAccount" runat="server" CssClass="ms-fullWidth" Text="contoso\administrator"></asp:TextBox>
                        </div>
                    </div>
