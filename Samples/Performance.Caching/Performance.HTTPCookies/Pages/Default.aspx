...
<asp:Content ContentPlaceHolderID="PlaceHolderPageTitleInTitleArea" runat="server">
    Caching Example App - Using Http Cookies
</asp:Content>
            ...
            <div id="divOverview" class="form-group">
                ...
                <div class="ms-core-form-line">
                    <div id="divDescription" class="ms-fullWidth">
                        ...
                        <p>This is a simple app that just reads your About Me section from your profile and caches it into a cookie. 
                           You can modify the About Me data and save it for later by storing it into a cookie. The idea is to save on trips to target services.
                           Clicking the "Clear Cache" button will delete (expire) the cookie and retrieve your About Me data from your profile again.
                           <br />
                           <br />
