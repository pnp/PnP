    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            using (ClientContext ctx = spContext.CreateUserClientContextForSPHost())
            {
                ...
                lblSiteColAdmin.Text = txtSiteColAdmin.Text;
            }
        }
        ...
        private string ResolveFutureUrl()
        {
            ...
            string hostWebUrl = Page.Request["SPHostUrl"].ToString();
            string rootSiteUrl = hostWebUrl.Substring(0, 8 + hostWebUrl.Substring(8).IndexOf("/"));

            //Resolve URL for the new site collection
            var webUrl = string.Format("{0}/sites/{1}", rootSiteUrl, txtUrl.Text);
            return webUrl;
        }

        private void AddRequestToQueue(Web web)
        {
            ...
            listItem["AdminAccount"] = txtSiteColAdmin.Text;
