...
namespace Core.ContentTypesAndFieldsWeb
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.hplScenario3.NavigateUrl = String.Format("~/pages/scenario3.aspx?{0}", SharePointUrlParameters());
            this.hplScenario4.NavigateUrl = String.Format("~/pages/scenario4.aspx?{0}", SharePointUrlParameters());
        }
