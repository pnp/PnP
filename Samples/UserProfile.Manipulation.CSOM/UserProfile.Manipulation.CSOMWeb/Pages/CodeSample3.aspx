<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CodeSample3.aspx.cs" Inherits="UserProfile.Manipulation.CSOMWeb.Pages.CodeSample3" %>
...
<body style="display: none; overflow: auto;">
    <form id="form1" runat="server">
        ...
        <div style="left: 40px; position: absolute;">
            ...
            <hr />
            <br />
            <asp:HyperLink ID="hplBack" runat="server" Text="Back" />
            to scenario listing...
        </div>
    </form>
</body>
