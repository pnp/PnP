...
namespace Perficient.Provisioning.VSTools
{
    static class GuidList
    {
        ...
        public const string guidPnPTemplateProvisioningItemCmdSetString = "52b48f09-8811-4ede-b47f-a305ce95e2bf";
        ...
        public static readonly Guid guidPnPTemplateProvisioningItemCmdSet = new Guid(guidPnPTemplateProvisioningItemCmdSetString);
