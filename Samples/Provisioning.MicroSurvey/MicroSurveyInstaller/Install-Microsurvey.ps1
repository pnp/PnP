...
Add-SPOFolder -Name SurveyApp -Folder "SiteAssets"

# Define source and destinations for the copy, as well as SharePoint app packaging files
# that we don't need
$localAppPath = (Get-Item -Path ..\MicroSurveySPApp\SurveyAppCentralDeploy).FullName
$spAppPath = "/SiteAssets/SurveyApp"
$filesToSkip = 'Elements.Xml', 'SharePointProjectItem.spdata', 'MicroSurvey.dwp', 'web.config'
