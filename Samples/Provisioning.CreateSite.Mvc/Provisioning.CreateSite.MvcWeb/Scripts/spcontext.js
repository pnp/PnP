(function (window, undefined) {
    ...
    function appendSPHostUrlToLinks(spHostUrl, currentAuthority) {
        ...
        // Appends the SPHostUrl to all of the form [action] attributes to keep context
        $("form")
            .each(function () {
                this.action += "?" + SPHostUrlKey + "=" + spHostUrl;
            });

        // Appends the SPHostUrl to all of the [data-val-remote-url] attributes to keep context
        $("[data-val-remote-url]")
            .each(function () {
                $(this).attr("data-val-remote-url", $(this).attr("data-val-remote-url") + "?" + SPHostUrlKey + "=" + spHostUrl);
            });
    }
