...
namespace Provisioning.CreateModernSites.Models
{
    public class IndexViewModel
    {
        ...
        [Required(ErrorMessage = "Please select a site classification for the \"modern\" site")]
        [DisplayName("Site Classification")]
        [UIHint("SiteClassification")]
