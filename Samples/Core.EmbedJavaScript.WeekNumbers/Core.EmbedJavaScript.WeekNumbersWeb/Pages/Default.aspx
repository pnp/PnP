<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Core.EmbedJavaScript.WeekNumbersWeb.Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="padding-left: 40px;">
            ...
            <p>Press the button below to upload JQuery and week numbers script files to <a href="javascript:navigateToHostWeb();">host web</a>'s site assets library. When doing this the code also adds custom actions so that the scripts get referenced when page is loaded. Navigate to a calendars monthly view and you should see the week numbers.</p>
